 ...
 *  提高：为菜单添加阴影
 */
public class PopDropDownBg extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_popdropdownbg);
    ...
    private void showPopupWindow() {
        View contentView = LayoutInflater.from(PopDropDownBg.this).inflate(R.layout.popuplayout_dropdownbg, null);
